...
// Manual:  az group create -n rg-file-transfer-prod -l eastus2 && az deployment group create -g rg-file-transfer-prod --template-file infra/main.bicep --parameters infra/parameters/prod.bicepparam
